...
//        ALL THIS CODE NEEDS TO BE DELETED AND WE NEED TO CLEAN IT UP
        //This does nothing right now cuz the code is broken and it also brings you to the welcome screen which we
        //do not need to do anymore now when they hit sign up it will bring them to a new page (i have this coded already)
